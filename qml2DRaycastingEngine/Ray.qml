...
Item {
    ...
    property double heading: Math.atan2(dir.y, dir.x)   // heading of Qt.vector2d(30, 50) is 1.0303768265243125

    property var raySize: 25                            // size of the ray for debugging purposes
    ...
    function show(ctx) {
        ...
        //console.log("Ray.show: pos=" + pos + " dir=" + dir + " angle=" + angle);
    }

    function setAngle(angle) {
        ray.dir = fromAngle(angle);
        //console.log("Ray.setAngle: dir=" + ray.dir);
    }
